<%@ Page Language="C#" AutoEventWireup="true" Inherits="SC.YPFB" Codebehind="YPFB.aspx.cs" %>
...
<body>
<div style="position:relative; margin:0 auto; max-width:780px;" >
  <form id="form1" runat="server">

  <!-- top -->
  <div style="z-index: 1; left: 0px; top: 0px; position: absolute; max-width: 780px; " runat="server" visible="false">
  ...
  <!-- left menu -->
  <div id="divLeftMenu" runat="server" enableviewstate="false" visible="false"
