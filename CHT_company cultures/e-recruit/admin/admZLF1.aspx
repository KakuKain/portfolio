<%@ Page Title="職類" Language="C#" MasterPageFile="admPage.master" AutoEventWireup="true" Inherits="SC.admZLF1" Codebehind="admZLF1.aspx.cs" %>
...
<asp:MultiView ID="MultiView1" runat="server">
        ...
        <td colspan="3" class="darkL" style="line-height:24px;">
          <table cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
            ...
            <tr>
              ...
              <td style="text-align: left;">
                啟用<asp:DropDownList ID="dropSelZLAct" runat="server">
            ...
            <tr>
              ...
              <td style="text-align: left;">
                <asp:DropDownList ID="dropSelOrder" runat="server">
                  <asp:ListItem Value="1">職類編號</asp:ListItem>
                  <asp:ListItem Value="2">職類名稱</asp:ListItem>
        ...
        <td colspan="3" align="center" class="light">
          ...
          <table id="itemTable" class="item" cellspacing="0" runat="server" style="width:840px;">
            <tr>
              ...
              <td class="title" style="width: 80px">職類編號</td>
              <td class="title">職類名稱</td>
  ...
  <asp:View ID="viewEdit" runat="server">
    <table class="tbMain" align="center" cellspacing="1" width="700px" >
        <tr>
          <th colspan="2" class="headC">職類</th>
        </tr>
        <tr>
          <td class="darkC" width="200px">職類編號</td>
          <td class="lightL" width="500px">
            <asp:TextBox ID="txtZLNO" runat="server" MaxLength="10" Width="150px" ></asp:TextBox>
          </td>
        </tr>
        <tr>
          <td class="darkC">職類名稱</td>
          <td class="lightL">
            <asp:TextBox ID="txtZLN" runat="server" MaxLength="50" Width="450px"></asp:TextBox>
          </td>
        </tr>
        <tr>
          <td class="darkC">啟用設定</td>
          <td class="lightL">
            <asp:RadioButtonList ID="rdZLACT" runat="server" RepeatDirection="Horizontal"
